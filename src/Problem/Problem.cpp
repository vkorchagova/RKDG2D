...
Problem::Problem(CaseInit task, const Time& t, Physics &ph) : time(t), physics(ph)
{
...
void Problem::setInitialConditions(CaseInit task)
{
    ...
    case forwardStep:
        ...
        initRho = [](const Point& r) { return 1.0; };
        initP   = [&](const Point& r) { return 1.0 / physics.cpcv;  };
    ...
    case acousticPulse:
        ...
        initP   = [=](const Point& r) { return pow(initRho(r), physics.cpcv);  };
        initU   = [](const Point& r) { return 0.0; };
        initV   = [](const Point& r) { return 0.0; };
